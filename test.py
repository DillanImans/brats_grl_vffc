...
from brats import get_datasets, get_datasets_independent, get_datasets_independent_2channel
...
def main(cfg: DictConfig):
    ...
    test_loader = get_datasets_independent(
    ...
    # test_loader = get_datasets_independent_2channel(
    # dataset_folder=dataset_folder,
    # mode="test",
    # target_size=(128,128,128),
    # version="brats2020",
